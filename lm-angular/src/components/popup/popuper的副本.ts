...
const popupDialog = function (option): any {
  if (!isBrowser) {
    return
  }
...
popupDialog.prototype.onClickMask = function (): void {
  this.params.hideOnBlur && this.params.onClose()
}

popupDialog.prototype._bindEvents = function (): void {
  if (this.params.hideOnBlur) {
...
popupDialog.prototype.show = function (): void {
...
popupDialog.prototype.hide = function (shouldCallback: Boolean = true): void{
...
popupDialog.prototype.destroy = function (): void {
