...
import Animate from './requestAnimationFrame'
import { easeOutCubic, easeInOutCubic } from '../../core/utils/tools';
import { querySelector, getStyle } from '../../core/utils/dom';
import { passiveSupported } from '../../core/utils/passive_supported';
...
export default class Scroller {
  ...
  protected build(container, options): any {
    ...
    let indicator = self.__indicator = component.querySelector('[data-role=indicator]')
  ...
  protected onChange(callback: Function): void {
    this.onEvent = callback;
  }
  protected onClose(): void {
    let self = this;
    console.log(self.__isAnimating, '__isAnimating')
  }
  /**
